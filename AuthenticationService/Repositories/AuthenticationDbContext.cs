...
namespace AuthenticationService.Repositories
{
    public class AuthenticationDbContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder builder)
        {
            ...
            var connectionString = "workstation id=authenticationdb4.mssql.somee.com;packet size=4096;user id=VuHiep0701_SQLLogin_1;pwd=xr93od43u4;data source=authenticationdb4.mssql.somee.com;persist security info=False;initial catalog=authenticationdb4;TrustServerCertificate=True";
